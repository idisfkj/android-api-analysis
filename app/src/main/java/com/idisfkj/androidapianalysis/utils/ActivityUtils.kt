...
import com.idisfkj.androidapianalysis.binder.BinderActivity
...
class ActivityUtils {
    companion object {
        ...
        private const val BINDER_TYPE = 4
        ...
        private fun createMainModel(type: Int): MainModel = when (type) {
            ...
            BINDER_TYPE -> MainModel("About of Binder", type, "Binder", R.layout.activity_binder_layout)
        ...
        fun getClassFromType(type: Int): Class<*> = when (type) {
            ...
            BINDER_TYPE -> BinderActivity::class.java
            else -> throw IllegalArgumentException("$type -> This type is not supported")
        }
    }
}
