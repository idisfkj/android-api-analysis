...
import com.idisfkj.androidapianalysis.coroutine.CoroutineActivity
...
class ActivityUtils {
    companion object {
        ...
        private const val COROUTINE_TYPE = 4
        ...
        private fun createMainModel(type: Int): MainModel = when (type) {
            ...
            COROUTINE_TYPE -> MainModel("About of Coroutine", type, "Coroutine", R.layout.activity_coroutine_layout)
        ...
        fun getMainModels(): List<MainModel> = mutableListOf(
                ...
                createMainModel(COROUTINE_TYPE)
        )
        ...
        fun getClassFromType(type: Int): Class<*> = when (type) {
            ...
            COROUTINE_TYPE -> CoroutineActivity::class.java
            else -> throw IllegalArgumentException("$type -> This type is not supported")
        }
    }
}
