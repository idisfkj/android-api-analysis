...
import com.idisfkj.androidapianalysis.datastore.DataStoreActivity
...
class ActivityUtils {
    companion object {
        ...
        private const val DATA_STORE = 4
        ...
        private fun createMainModel(type: Int): MainModel = when (type) {
            ...
            DATA_STORE -> MainModel("Jetpack DataStore", type, "DataStore", R.layout.activity_data_store_layout)
        ...
        fun getClassFromType(type: Int): Class<*> = when (type) {
            ...
            DATA_STORE -> DataStoreActivity::class.java
            else -> throw IllegalArgumentException("$type -> This type is not supported")
        }
    }
}
