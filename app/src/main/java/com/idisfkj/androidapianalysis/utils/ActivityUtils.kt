...
import com.idisfkj.androidapianalysis.navigation.NavigationMainActivity
...
class ActivityUtils {
    companion object {
        ...
        private const val NAVIGATION_TYPE = 0x0010
        ...
        private fun createMainModel(type: Int): MainModel = when (type) {
            ...
            NAVIGATION_TYPE -> MainModel("About of Navigation", type, "Navigation", R.layout.activity_navigation_main)
        ...
        fun getMainModels(): List<MainModel> = mutableListOf(
                ...
                createMainModel(NAVIGATION_TYPE)
        )
        ...
        fun getClassFromType(type: Int): Class<*> = when (type) {
            ...
            NAVIGATION_TYPE -> NavigationMainActivity::class.java
            else -> throw IllegalArgumentException("$type -> This type is not supported")
        }
    }
}
